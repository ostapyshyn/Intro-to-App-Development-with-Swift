...
let totalNumberOfAnimals = numberOfDogs + numberOfCats + numberOfTurtles + numberOfHamsters + potBelliedPig

let totalNumberOfMammals = numberOfDogs + numberOfCats + numberOfHamsters + fish + snake
