...
struct Rectangle2 {
    ...
    func isBiggerThan(_ rectangle: Rectangle2) -> Bool {
        //let areaOne = width * height
        //let areaTwo = rectangle.width * rectangle.height
...
let rectangle1 = Rectangle2(width: 10, height: 10)
let otherRectangle1 = Rectangle2(width: 10, height: 20)

rectangle1.isBiggerThan(otherRectangle1)
otherRectangle1.isBiggerThan(rectangle1)
