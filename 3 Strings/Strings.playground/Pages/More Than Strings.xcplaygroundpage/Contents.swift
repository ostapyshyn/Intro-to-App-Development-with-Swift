...
let story = "Today was a big day for \(name). They had finally saved up \(dollars) dollars and were going to buy a \(size) \(thing). They went to the \(place) feeling very \(emotion). But then they felt \(negativeEmotion). They were all out of \(money)!"
