...
func impossibleThingsPhrase(numberOfImpossibleThings: Int, meal: String) -> String {
    let numberOfImpossibleThings = numberOfImpossibleThings
    let meal = meal
...
let impossibleCount = impossibleBeliefsCount(pigsFlying: 3, frogsBecomingPrinces: 4, multipleLightningStrikes: 2)
let phrase = impossibleThingsPhrase(numberOfImpossibleThings: impossibleCount, meal: "food")
print(phrase)
