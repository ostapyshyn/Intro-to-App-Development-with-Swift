...
*/
func fav(categoryOfThing: String, favorite: String ) -> String {
    return "My favorite \(categoryOfThing) is \(favorite)"
}

let sentence = fav(categoryOfThing: "food", favorite: "cheese")
print(sentence)
let movie = fav(categoryOfThing: "movie", favorite: "Matrix")
print(movie)
