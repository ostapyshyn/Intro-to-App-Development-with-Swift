...
var secondRope = TreehousePulley(weightCapacity: 2000)

ricketyRope.canHandleAdditionalLoad(2 * item1)


secondRope.canHandleAdditionalLoad(1 * item1 + 2 * item2 + item3)

ricketyRope.addLoadToBasket(loadWeight:2 * item1)
secondRope.addLoadToBasket(loadWeight: 1 * item1 + 2 * item2 + item3)
